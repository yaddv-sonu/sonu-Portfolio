...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
          Versatile and growth-driven Software Developer with a passion for building intuitive, high-performance web applications. I specialize in modern frontend development and have experience across the full stack, including deployment
          and DevOps workflows.
        </div>
        <div className="w-fit break-words">
          <a
            href="mailto:yadavsonu.in@gmail.com"
        ...
        <Link
          href="document/sonu_yadav_resume.pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
